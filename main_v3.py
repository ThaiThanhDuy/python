...
class MainWindow(QtWidgets.QMainWindow):
        ...
        if not self.ai_dang_chay:
            ...
            with sr.Microphone() as source:
                ...
                try:
                    ...
                    self.ui.label_tra_loi_ai.setText("✅ Đã ghi âm xong. Nhấn 'Xác nhận' để gửi.")
                except sr.UnknownValueError:
                    self.ui.label_cau_hoi_ai.setText("❌ Không thể nhận diện được giọng nói.Bạn bấm Hủy để bắt đầu lại nhé ")
                    self.ui.label_tra_loi_ai.setText("")
                except sr.RequestError as e:
                    self.ui.label_cau_hoi_ai.setText(f"❌ Lỗi kết nối: {e}")
                    self.ui.label_tra_loi_ai.setText("")
                except sr.WaitTimeoutError:
                    self.ui.label_cau_hoi_ai.setText("⌛ Hết thời gian chờ. Bạn chưa nói gì.")
            ...
            self.ui.label_cau_hoi_ai.clear()
            self.ui.label_tra_loi_ai.clear()
            self.ui.label_lang_nghe.setText("🔴🔴 Bạn muốn tra cứu thì hãy bấm bắt đầu nhé !")
    ...
    def huy_cau_hoi_ai(self):
        self.cau_hoi_text = ""
        self.ui.label_cau_hoi_ai.setText("🔄 Câu hỏi đã bị hủy. Vui lòng nhấn 'Bắt đầu' để thu lại.")
        self.ui.label_tra_loi_ai.setText("")
        self.ui.btn_bat_dau_ai.setText("Bắt đầu")
        self.ai_dang_chay = False
